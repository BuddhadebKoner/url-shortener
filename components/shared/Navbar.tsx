...
const Navbar = () => {
   return (
      <>
         <nav className="w-full py-4 sm:py-5 px-4 sm:px-6 flex items-center justify-between border-b border-border/40 backdrop-blur-xl bg-background/30 sticky top-0 z-10">
            ...
            <h1 className="text-primary text-xl sm:text-2xl font-bold tracking-tight relative group">
               <span className="relative z-10 group-hover:text-accent transition-colors duration-300 neon-text">abcredirect</span>
