...
const Services = () => {
  const features = [
    { title: "Secure", icon: "🔒", desc: "All links use HTTPS encryption", link: "" },
    { title: "Analytics", icon: "📊", desc: "Track clicks and visitor data", link: "/analysis" },
    { title: "Custom URLs", icon: "✨", desc: "Create branded short links", link: "/custom" },
  ]
